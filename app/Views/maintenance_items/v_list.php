        ...
        <div class="row">
            <div class="col-lg-12">
                                ...
                                <form method="GET" id="filter_form">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-3">
                                            <div class="form-group">
                                                <label>City</label>
                                                <input name="city" value="<?= @$_GET["city"]; ?>" type="text" class="form-control" placeholder="City ...">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
                ...
                <div class="row" style="margin-bottom:10px;">
                    <div class="col-2">
                        <button class="btn btn-primary" onclick="window.location='<?= base_url(); ?>/maintenance_item/add';"><i class="fa fa-plus"></i></button>
                    </div>
                </div>
                <div class="card">
                    <!--PAGING -->
                        ...
                        <table class="table table-head-fixed text-nowrap table-striped">
                            ...
                            <tbody>
                                ...
                                ?>
                                    <tr>
                                        <td>
                                            <a class="btn btn-info btn-sm" href="<?= base_url(); ?>/maintenance_item/edit/<?= $item->id; ?>">
                                                <i class="fas fa-edit"></i>
                                            </a>
                                            <a class="btn btn-danger btn-sm" href="#" onclick="delete_confirmation(<?= $item->id; ?>);">
                                        ...
                                        <td><?= $item_detail[$item->id]["item_sub_category"]; ?></td>
                                        <td><?= $item_detail[$item->id]["item_type"]; ?></td>
                                        <td><?= $item->name; ?></td>
                                        <td><?= $item->city; ?></td>
                                        <td><?= $item->province; ?></td>
                                        <td><?= substr($item->address, 0, 100); ?></td>
...
<script>
    function delete_confirmation(id) {
        ...
        $('#modal_ok_link').attr("href", '<?= base_url(); ?>/maintenance_item/delete/' + id);
        $('#modal-form').modal();
    }
</script>