...
class Unbalance_journal extends BaseController
{
    protected $menu_ids;
    ...
    {
        parent::__construct();
        $this->route_name = "unbalance_journals";
    ...
    public function index()
    {
        ...
        $data["__modulename"] = "Unbalance Journals";
        $startrow = $page * MAX_ROW;

        $wherclause = "is_deleted = '0' AND id IN (SELECT journal_id FROM (SELECT journal_id,sum(journal_details.debit)-sum(journal_details.credit) as balance FROM journal_details GROUP BY journal_details.journal_id) as tbl where tbl.balance != 0) ";
        ...
        echo view('v_menu');
        echo view('unbalance_journals/v_list');
        echo view('v_footer');
    }
    ...
    public function edit($id)
    {
        ...
        if (isset($_POST["Save"])) {
            ...
            return redirect()->to(base_url() . '/unbalance_journals');
        }

        $data["__modulename"] = "Edit Unbalance Journal";
        ...
        echo view('v_header', $data);
        echo view('v_menu');
        echo view('unbalance_journals/v_edit');
        echo view('v_footer');
        echo view('unbalance_journals/v_js');
    }
