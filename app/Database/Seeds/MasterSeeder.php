...
class MasterSeeder extends \CodeIgniter\Database\Seeder
{
    public function run()
    {
        ...
        $data = [
            ...
            ['seqno'  => '6',    'parent_id'  =>  '2',    'name'  =>  'Tires',    'url'  =>  'tires',   'icon'  =>  'far fa-life-ring'],
            ['seqno'  => '7',    'parent_id'  =>  '2',    'name'  =>  'Vehicle Brand',    'url'  =>  'vehicle_brands',   'icon'  =>  'fas fa-car'],
            ['seqno'  => '8',    'parent_id'  =>  '2',    'name'  =>  'Vehicle Type',    'url'  =>  'vehicle_types',   'icon'  =>  'fas fa-shuttle-van'],
            ['seqno'  => '9',    'parent_id'  =>  '2',    'name'  =>  'Vehicles',    'url'  =>  'vehicles',   'icon'  =>  'fas fa-truck'],
