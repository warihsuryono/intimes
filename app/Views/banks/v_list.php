        ...
        <div class="row">
            <div class="col-lg-12">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-3">
                                            <div class="form-group">
                                                ...
                                                <input name="name" value="<?= @$_GET["name"]; ?>" type="text" class="form-control" placeholder="Bank Name ...">
                                            </div>
                                        </div>
                                        <div class="col-sm-3">
                                            <div class="form-group">
                                                <label>No Rekening</label>
                                                <input name="norek" value="<?= @$_GET["norek"]; ?>" type="text" class="form-control" placeholder="No Rekening ...">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
                ...
                <div class="row" style="margin-bottom:10px;">
                    <div class="col-2">
                        <button class="btn btn-primary" onclick="window.location='<?= base_url(); ?>/bank/add';"><i class="fa fa-plus"></i></button>
                    </div>
                </div>
                <div class="card">
                    <!--PAGING -->
                        ...
                        <table class="table table-head-fixed text-nowrap table-striped">
                            ...
                            <tbody>
                                ...
                                ?>
                                    <tr>
                                        <td>
                                            <a class="btn btn-info btn-sm" href="<?= base_url(); ?>/bank/edit/<?= $bank->id; ?>">
                                                <i class="fas fa-edit"></i>
                                            </a>
                                            <a class="btn btn-danger btn-sm" href="#" onclick="delete_confirmation(<?= $bank->id; ?>);">
                                        ...
                                        <td><?= $bank->id; ?></td>
                                        <td><?= $bank->code; ?></td>
                                        <td><?= $bank_detail[$bank->id]["coa"]; ?></td>
                                        <td><?= $bank->name; ?></td>
                                        <td><?= $bank->norek; ?></td>
                                        <td><?= $bank_detail[$bank->id]["currency"]; ?></td>
                                        <td><?= ($bank->is_debt == "1") ? "Yes" : "No"; ?></td>
