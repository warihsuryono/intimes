        ...
        <div class="row">
            <div class="col-lg-12">
                                    ...
                                    <div class="row">
                                        <div class="col-sm-3">
                                            <div class="form-group">
                                                <label>Item Receive No</label>
                                                <input name="item_receive_no" value="<?= @$_GET["item_receive_no"]; ?>" type="text" class="form-control" placeholder="Item Receive No ...">
                                            </div>
                                        </div>
                                        <div class="col-sm-3">
                                            <div class="form-group">
                ...
                <div class="row" style="margin-bottom:10px;">
                    <div class="col-2">
                        <button class="btn btn-primary" onclick="window.location='<?= base_url(); ?>/item_receive/add';"><i class="fa fa-plus"></i></button>
                    </div>
                </div>
                <div class="card">
                    <!--PAGING -->
                        ...
                        <table class="table table-head-fixed text-nowrap table-striped">
                            ...
                            <tbody>
                                ...
                                ?>
                                    <tr>
                                        <td>
                                            <a class="btn btn-info btn-sm" href="<?= base_url(); ?>/item_receive/view/<?= $item_receive->id; ?>">
                                                <i class="fas fa-eye"></i>
                                            </a>
                                            <a class="btn btn-info btn-sm" href="<?= base_url(); ?>/item_receive/edit/<?= $item_receive->id; ?>">
                                                <i class="fas fa-edit"></i>
                                            </a>
                                            <a class="btn btn-danger btn-sm" href="#" onclick="delete_confirmation(<?= $item_receive->id; ?>);">
                                                <i class="fas fa-trash"></i>
                                            </a>
                                        </td>
                                        <td><?= $no; ?></td>
                                        <td><?= $item_receive->id; ?></td>
                                        <td><?= $item_receive->item_receive_no; ?></td>
                                        <td><?= $item_receive->po_no; ?></td>
                                        <td><?= $item_receive_detail[$item_receive->id]["supplier"]; ?></td>
                                        <td><?= date("d-m-Y H:i:s", strtotime($item_receive->created_at)); ?></td>
                                        <td><?= $item_receive->created_by; ?></td>
                                        <td><?= ($item_receive->is_approved) ? "<i class='btn btn-success'>Yes</i>" : "<i class='btn btn-danger'>No</i>"; ?></td>
                                    </tr>
                                <?php endforeach ?>
                            </tbody>
                        </table>
