        ...
        <div class="row">
            <div class="col-lg-12">
                                    ...
                                    <div class="row">
                                        <div class="col-sm-3">
                                            <div class="form-group">
                                                <label>Journal At</label>
                                                <input name="journal_at" value="<?= @$_GET["journal_at"]; ?>" type="date" class="form-control" placeholder="Date ...">
                                            </div>
                                        </div>
                                        <div class="col-sm-3">
                                            <div class="form-group">
                                                <label>Invoice No</label>
                                                <input name="invoice_no" value="<?= @$_GET["invoice_no"]; ?>" type="text" class="form-control" placeholder="Invoice No ...">
                                            </div>
                                        </div>
                                        <div class="col-sm-3">
                                            <div class="form-group">
                ...
                <div class="row" style="margin-bottom:10px;">
                    <div class="col-2">
                        <button class="btn btn-primary" onclick="window.location='/journal/add';"><i class="fa fa-plus"></i></button>
                    </div>
                </div>
                <div class="card">
                    <!--PAGING -->
                        ...
                        <table class="table table-head-fixed text-nowrap table-striped">
                            ...
                            <tbody>
                                ...
                                ?>
                                    <tr>
                                        <td>
                                            <a class="btn btn-info btn-sm" href="<?= base_url(); ?>/journal/edit/<?= $journal->id; ?>">
                                                <i class="fas fa-edit"></i>
                                            </a>
                                            <a class="btn btn-danger btn-sm" href="#" onclick="delete_confirmation(<?= $journal->id; ?>);">
                                                <i class="fas fa-trash"></i>
                                            </a>
                                        </td>
                                        <td><?= $no; ?></td>
                                        <td><?= $journal->id; ?></td>
                                        <td><?= date("d-m-Y", strtotime($journal->journal_at)); ?></td>
                                        <td><?= $journal->invoice_no; ?></td>
                                        <td><?= $journal->description; ?></td>
                                        <td align="right"><?= number_format($journal_detail[$journal->id]["debit"], 2, ",", "."); ?></td>
                                        <td align="right"><?= number_format($journal_detail[$journal->id]["credit"], 2, ",", "."); ?></td>
                                        <td><?= date("d-m-Y H:i:s", strtotime($journal->created_at)); ?></td>
