                        ...
                        <table class="table table-head-fixed text-nowrap table-striped">
                            ...
                            <tbody>
                                ...
                                ?>
                                    <tr>
                                        <td>
                                            <a class="btn btn-info btn-sm" href="<?= base_url(); ?>/calibration_verification/view/<?= $calibration_verification->id; ?>">
                                                <i class="fas fa-eye"></i>
                                            </a>
                                            <a class="btn btn-info btn-sm" href="<?= base_url(); ?>/calibration_verification/edit/<?= $calibration_verification->id; ?>">
                                                <i class="fas fa-edit"></i>
                                            </a>
                                            <a class="btn btn-danger btn-sm" href="#" onclick="delete_confirmation(<?= $calibration_verification->id; ?>);">
                                                <i class="fas fa-trash"></i>
                                            </a>
                                        </td>
                                        <td><?= $no; ?></td>
                                        <td><?= date("d-m-Y", strtotime(@$calibration_verification_detail[$calibration_verification->id]["calibration_form"]->calibration_at)); ?></td>
                                        <td><?= @$calibration_verification_detail[$calibration_verification->id]["instrument_acceptance"]->customer_name; ?></td>
                                        <td><?= $calibration_verification->sample_no; ?></td>
                                        <td><?= $calibration_verification->brand; ?></td>
                                        <td><?= $calibration_verification->instrument_type; ?></td>
                                        <td><?= $calibration_verification->serialnumber; ?></td>
                                        <td><?= $calibration_verification->calibrated_by; ?></td>
                                        <td><?= $calibration_verification->calculated_by; ?></td>
                                        <td><?= $calibration_verification->verified_by; ?></td>
                                        <td><?= ($calibration_verification_detail[$calibration_verification->id]["is_calibration_certificated"]) ? "<i class='btn btn-success'>Sudah</i>" : "<i class='btn btn-danger'>Belum</i>"; ?></td>
                                        <td><?= ($calibration_verification_detail[$calibration_verification->id]["is_instrument_released"]) ? "<i class='btn btn-success'>Sudah</i>" : "<i class='btn btn-danger'>Belum</i>"; ?></td>
                                    </tr>
                                <?php endforeach ?>
                            </tbody>
                        </table>
...
<script>
    function delete_confirmation(id) {
        ...
        $('#modal_ok_link').attr("href", '<?= base_url(); ?>/calibration_verification/delete/' + id);
        $('#modal-form').modal();
    }
</script>